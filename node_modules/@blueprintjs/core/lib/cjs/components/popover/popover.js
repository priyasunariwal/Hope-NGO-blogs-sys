...
var Popover = /** @class */ (function (_super) {
    ...
    function Popover() {
        ...
        _this.handlePopoverClick = function (e) {
            ...
            var dismissElementV1 = eventTarget.closest(".".concat(common_1.Classes.POPOVER_DISMISS, ", .").concat(common_1.Classes.POPOVER_DISMISS_OVERRIDE));
            var shouldDismiss = (_d = (_c = dismissElement === null || dismissElement === void 0 ? void 0 : dismissElement.classList.contains(common_1.Classes.POPOVER_DISMISS)) !== null && _c !== void 0 ? _c : dismissElementV1 === null || dismissElementV1 === void 0 ? void 0 : dismissElementV1.classList.contains(common_1.Classes.POPOVER_DISMISS)) !== null && _d !== void 0 ? _d : false;
    ...
    Popover.prototype.render = function () {
        ...
        return (React.createElement(react_popper_1.Manager, null,
            React.createElement(react_popper_1.Reference, { innerRef: this.targetRef }, this.renderTarget),
    ...
    Popover.prototype.updateDarkParent = function () {
        if (this.props.usePortal && this.state.isOpen) {
            var hasDarkParent = this.targetRef.current != null && this.targetRef.current.closest(".".concat(common_1.Classes.DARK)) != null;
