...
export const AnchorButton = React.forwardRef((props, ref) => {
    ...
    return (React.createElement("a", { role: "button", ...removeNonHTMLProps(props), ...commonProps, href: commonProps.disabled ? undefined : href, tabIndex: commonProps.disabled ? -1 : tabIndex }, renderButtonContents(props)));
});
...
function renderButtonContents(props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        hasTextContent && (React.createElement("span", { key: "text", className: Classes.BUTTON_TEXT },
            text,
            children)),
